...
<head>
    ...
    <title>UPDATE the Electricity Bill</title>
</head>
<body>
    <div class="container">
            ...
            <div class="card" style="width: 26rem; padding-top: 15px;"> <!-- Added padding-top -->
                <div class="card-body">
                    <form action="{{ route('updateElec', $electricity->id) }}" method="POST" >
                        ...
                        @csrf
                        <label>Date </label>
                        <input class="form-control form-control-lg" type="date" placeholder="Date " name="date" aria-label=".form-control-lg example" value="{{$electricity->date}}">
                        <label>Due Date </label>
                        <input class="form-control form-control-lg" type="date" placeholder="Due Date " name="duedate" aria-label=".form-control-lg example" value="{{$electricity->duedate}}">
                        <label>Amount </label>
                        <input class="form-control form-control-lg" type="text" placeholder="Amount " name="amount" aria-label=".form-control-lg example" value="{{$electricity->amount}}">
                        <label>Status </label>
                        ...
                        <a href="{{route('getElec')}}" class="card-link">
