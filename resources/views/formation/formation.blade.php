    ...
    <table class="w-full whitespace-no-wrap">
      <thead>
        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
          ...
          <th><a href="{{route('createFormation')}}"><button class="add"> Add a formation</button></a></th>
        </tr>
      </thead>
            ...
            @foreach($formations as $rs )
                ...
                <td class="px-4 py-3">
                    ...
                    <div class="relative hidden w-12 h-12 mr-3 rounded-full md:block">
                        <img class="object-cover w-full h-full rounded-full" src="formation.jpeg" alt="" loading="lazy"/>
                ...
                <td class="px-4 py-3">
                   ...
                   <a href=""> <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                    ...
                    <form action="{{ route('deleteFormation', ['id' => $rs->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <div class="flex items-center space-x-4 text-sm">
