            ...
            @foreach($teachers as $rs )
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                        <button class="edit-Teacher-modal flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit" data-toggle="modal" data-target="#editTeacherModal" data-Teacher-id="{{$rs->id}}" data-Teacher-name="{{$rs->name}}" data-Teacher-cin="{{$rs->cin}}" data-Teacher-phone="{{$rs->phone}}" data-Teacher-email="{{$rs->email}}" data-Teacher-dob="{{$rs->date_naissance}}" data-Teacher-class="{{$rs->classe_id}}">
