...
<li class="relative">
  <button
      class="flex items-center justify-center w-10 h-10 focus:outline-none focus:ring rounded-full bg-gray-200 dark:bg-gray-700"
  ...
  <template x-if="isProfileMenuOpen">
      ...
      >
          @if(session('authenticated'))
              <li class="block py-2 pl-4 text-sm font-medium border-l-4 border-transparent hover:bg-gray-100 dark:hover:bg-gray-600 hover:border-indigo-500">
