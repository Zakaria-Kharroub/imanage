...
<div class="w-full overflow-x-auto">
    <div class="mb-4">
        <form id="searchForm">
            <input type="text" id="searchInput" placeholder="Search by name..." class="px-4 py-2 border rounded-md">
            <button type="button" id="searchButton" class="px-4 py-2 bg-blue-500 text-white rounded-md">Search</button>
        </form>
    </div>
